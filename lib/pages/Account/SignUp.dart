        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Create your account to get started', style: GoogleFonts.nunito(fontSize: screenWidth * 0.04, color: Colors.grey[400])),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Create Account', style: GoogleFonts.nunito(fontSize: screenWidth * 0.04, color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ),
              SizedBox(height: screenHeight * 0.03),
              Row(
